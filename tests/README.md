...
This directory contains centralized tests organized by the canonical pipeline structure. 

Files are organized by `tools/organize_canonical_structure.py` to maintain consistency with the canonical flow organization in the parent directories.
