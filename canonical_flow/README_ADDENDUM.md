# Addendum (Canonical Copy): Canonical Flow, Compatibility Audit, and New Documentation

This is a canonical copy of the addendum. See ../README_ADDENDUM.md for the source.
...
Additional documentation in this folder:
- README_INNOVATION.md — innovation and differentiators (canonical copy)
- README_CONTRACTS.md — contract suite and validation commands (canonical copy)
