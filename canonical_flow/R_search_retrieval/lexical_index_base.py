...
Source: retrieval_engine/lexical_index.py
...
# Alias metadata
alias_source = r"retrieval_engine/lexical_index.py"
...
try:
    ...
    original_file = project_root / "retrieval_engine/lexical_index.py"
