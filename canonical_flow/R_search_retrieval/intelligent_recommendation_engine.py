...
Source: intelligent_recommendation_engine.py
...
# Alias metadata
alias_source = r"intelligent_recommendation_engine.py"
...
try:
    ...
    original_file = project_root / "intelligent_recommendation_engine.py"
