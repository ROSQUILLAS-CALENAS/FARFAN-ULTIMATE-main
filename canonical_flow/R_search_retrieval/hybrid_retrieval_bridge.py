...
Source: hybrid_retrieval_bridge.py
...
# Alias metadata
alias_source = r"hybrid_retrieval_bridge.py"
...
try:
    ...
    original_file = project_root / "hybrid_retrieval_bridge.py"
