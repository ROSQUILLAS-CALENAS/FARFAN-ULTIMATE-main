...
Source: deterministic_hybrid_retrieval.py
...
# Alias metadata
alias_source = r"deterministic_hybrid_retrieval.py"
...
try:
    ...
    original_file = project_root / "deterministic_hybrid_retrieval.py"
