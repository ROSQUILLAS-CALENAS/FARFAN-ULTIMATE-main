...
Source: retrieval_engine/hybrid_retriever.py
...
# Alias metadata
alias_source = r"retrieval_engine/hybrid_retriever.py"
...
try:
    ...
    original_file = project_root / "retrieval_engine/hybrid_retriever.py"
