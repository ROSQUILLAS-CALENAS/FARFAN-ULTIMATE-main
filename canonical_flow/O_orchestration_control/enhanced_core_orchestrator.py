...
Source: enhanced_core_orchestrator.py
...
# Alias metadata
alias_source = r"enhanced_core_orchestrator.py"
...
try:
    ...
    original_file = project_root / "enhanced_core_orchestrator.py"
